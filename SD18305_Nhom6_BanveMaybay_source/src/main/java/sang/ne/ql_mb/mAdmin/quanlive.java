 ...
 * @author CCLaptop.com
 */
public class quanlive extends javax.swing.JPanel {
    ...
    private void LoadDataTable(KhachHang kh){
        try {
            ...
            List <PhieuDatCho> list = pdc.findALLPhieuDatCho();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tb_ve);
